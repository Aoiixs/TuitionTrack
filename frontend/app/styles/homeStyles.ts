...
export default StyleSheet.create({
  ...
  container1:{flex: 1, alignSelf: "center", marginLeft: 50},
  ...
  send:{display: "flex", alignSelf: "center", height: 263, width: 50, marginLeft: -30, marginTop: 75, },
  ...
  header1:{alignSelf: "center",  fontWeight: "bold", fontSize: 15, marginLeft: 6},
  headers: {color: "white", fontSize: 18, alignSelf: "center", marginBottom: 280, marginRight: 130},
